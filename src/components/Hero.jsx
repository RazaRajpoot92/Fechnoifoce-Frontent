    ...
    <section className="pt-14 flex justify-center relative overflow-hidden min-h-screen md:h-[80vh] lg:h-screen 2xl:h-[55vh] bg-gray-900 text-white">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:justify-around w-full max-w-6xl relative px-4 md:px-6 gap-8">
        ...
        <div data-aos='fade-right' className="flex flex-col gap-5 md:gap-6 md:w-1/2 items-center md:items-start text-center md:text-left">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-100 leading-7 tracking-wide px-2 sm:px-0">
            Delivering reliable <span className="text-gray-100">electromechanical</span> and <span className="text-gray-100">packaging</span> solutions that keep industries
