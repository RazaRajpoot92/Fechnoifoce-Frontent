...
const CTASection = () => {
  return (
    <div  className="w-full flex items-center justify-center py-4 pt-6 bg-gray-900">
      <div data-aos = 'zoom-in' className="w-11/12 sm:w-10/12 md:w-9/12 lg:w-[800px] rounded-2xl py-16 sm:py-20  bg-linear-to-r from-violet-600 via-purple-600 to-purple-800 text-white flex flex-col items-center justify-center">
